								...
								<div class="grid-item product portrait grid-sizer">
									...
									<div class="product-details center">
										<h3 class="product-title">
											<a href="">
												<span class="font-alt-2"></span>{{ $course->title }}
											</a>
										</h3>
										<span class="product-price price"><del><span class="amount"></span></del><ins><span class="amount">Rs. {{ $course->fee }}</span></ins></span>

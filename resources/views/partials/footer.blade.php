    ...
    <div class="row flex">
        <div class="column width-3">
            <div class="widget">
                ...
                <p>Online Tutor service began in 2018 and since then we’ve helped thousands of students to find the specialist help they need, whether that’s a one-off response to a specific problem or ongoing support around a challenging subject.</p>
            </div>
        </div>
        <div class="column width-3">
            <div class="widget">
                <h4 class="widget-title weight-light">Online Tutor News</h4>
        ...
        <div class="column width-3">
            <div class="widget">
                ...
                <p class="mb-20">Want to be notified when we launch a new template or an udpate. Just sign up and we will send you a notification by email.</p>
                <div class="signup-form-container">
                    <form class="signup-form" action="php/subscribe.php" method="post" novalidate>
                        <div class="row">
                            <div class="column width-12 left">
                                <div class="field-wrapper">
                                    <input type="email" name="email" class="form-email form-element no-padding-left no-padding-right" placeholder="Email address*" required>
                                </div>
                            </div>
        ...
        <div class="column width-12">
            <div class="footer-bottom-inner center">
                <p class="copyright pull-left clear-float-on-mobile">
                    &copy; Online Tutor. All Rights Reserved. <a href="#">Terms &amp; Conditions</a> | <a href="#">Cookie policy</a>
                </p>

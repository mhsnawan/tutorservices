                                                ...
                                                <form method="POST" action="{{ route("certification.update", $certification->id) }}" enctype="multipart/form-data">
                                                    ...
                                                    <div class="row">
                                                        <div class="column width-10">
                                                            <div class="field-wrapper">
                                                                <label>Certification Name</label>
                                                                <input type="text" name="title" value="{{ $certification->name }}" class="form-fname form-element large" placeholder="Certification or Reward*" tabindex="1" required>
                                                            </div>
                                                        </div>
                                                        <div class="column width-10">
                                                            <div class="field-wrapper">
                                                        ...
                                                        <div class="column width-6">
                                                            <div class="field-wrapper">
                                                                ...
                                                                <div class="form-select form-element large">
                                                                    <select name="year" tabindex="3" class="form-aux" data-label="Year">
                                                                        @for ($i = 2018; $i >= 1960; $i--)
                                                                        <option value="{{ $i }}" @if($certification->year == $i) selected @endif>{{ $i }}</option>
                                                                        @endfor
                                                                    </select>
                                                                </div>
                                                            </div>
